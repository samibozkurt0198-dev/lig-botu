...
class KapFormuModal(discord.ui.Modal, title="📝 Transfer Teklifi Formu"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if market_kanal:
            await market_kanal.send(content=f"📢 {self.hedef_oyuncu.mention}", embed=dedikodu_embed)
        ...
        await interaction.response.send_message(content=f"{self.hedef_oyuncu.mention}", embed=onay_embed, view=view)
